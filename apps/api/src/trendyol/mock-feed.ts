import type { OrderListItem, OrderMoney, ProductListItem, ReturnListItem } from '@magazakit/contracts';

function seedMoney(over: Partial<OrderMoney> = {}): OrderMoney {
  return {
    grossTry: 115,
    sellerDiscountTry: 0,
    tyDiscountTry: 0,
...
const ORDERS: Omit<OrderListItem, 'organizationId'>[] = [
  ...
  },
  {
    ...
    lines: [{ listingId: 'ty-p-1003', qty: 1, scannedQty: 0, title: '3’lü çorap seti' }],
    reserved: false,
    reservationKey: null,
    packed: true,
    labeled: false,
