...
| ikas | OAuth `client_credentials` + `listProduct` / `listOrder` + `orderLineItems.variant.sku` | [auth](https://builders.ikas.com/docs/app-development/private-app/authentication), [Order](https://ikas.dev/docs/api/admin-api/orders) | Token `expires_in` (14400sn) önbellekte. |
